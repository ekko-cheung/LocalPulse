...
const messages = {
  zh: {
    ...
    settings: {
      ...
      allowedPrograms: '本地程序白名单',
      allowedProgramsPlaceholder: '例如：python,node,/path/to/script',
      saveAllowedPrograms: '保存白名单',
      savingAllowedPrograms: '保存中…',
      allowedProgramsSaved: '白名单已更新',
      allowedProgramsSaveFailed: '白名单保存失败',
      allowedProgramsHint: '使用英文逗号分隔程序名或完整路径；留空表示不允许执行本地程序。',
    },
    hooks: {
      title: 'AI Agent 提醒',
      copy: '在请求权限或完成操作时发送系统通知',
      agent: 'Agent',
      scope: '生效范围',
      global: '所有项目',
      project: '指定项目',
      ...
      installed: '已安装',
      empty: '未安装',
      hint: '项目规则只在本机生效。LocalPulse 需保持运行；Codex 首次使用时请在 /hooks 中信任新增 hooks。',
    },
    jobs: {
      emptyTitle: '还没有任务',
    ...
    modal: {
      ...
      runAtInvalid: '请选择有效的执行时间',
      configInvalid: '动作配置必须是 JSON 对象',
      retryInvalid: '重试次数和间隔必须是有效的非负整数',
  ...
  en: {
    ...
    settings: {
      ...
      allowedPrograms: 'Local program allowlist',
      allowedProgramsPlaceholder: 'For example: python,node,/path/to/script',
      saveAllowedPrograms: 'Save allowlist',
      savingAllowedPrograms: 'Saving…',
      allowedProgramsSaved: 'Allowlist updated',
      allowedProgramsSaveFailed: 'Could not save the allowlist',
      allowedProgramsHint:
        'Separate program names or full paths with commas; leave empty to disable local program execution.',
    },
    hooks: {
      title: 'AI Agent notifications',
      copy: 'Send system notifications for approval requests and completed work',
      agent: 'Agent',
      scope: 'Applies to',
      global: 'All projects',
      project: 'Selected project',
      projectPath: 'Select a project folder',
      browse: 'Browse…',
      permission: 'Permission request',
      stop: 'Response complete',
      tool: 'Each tool operation complete',
      install: 'Save and install hooks',
      remove: 'Remove',
      installed: 'Installed',
      empty: 'Not installed',
      hint: 'Project rules stay on this machine. Keep LocalPulse running; trust new Codex hooks in /hooks before first use.',
    },
    jobs: {
    ...
    modal: {
      ...
      backoffSeconds: 'Retry interval (seconds)',
      createdAt: 'Created',
      updatedAt: 'Updated',
      edit: 'Edit task',
      create: 'Create task',
      ...
      cronInvalid: 'The Cron expression is invalid',
      intervalInvalid: 'Interval seconds must be an integer greater than 0',
      runAtInvalid: 'Choose a valid run time',
      configInvalid: 'Action config must be a JSON object',
      retryInvalid: 'Retry count and interval must be valid nonnegative integers',
